...
# 1. STANDINGS & BACKUPS
# ─────────────────────────────────────────────────────────────────────────────
# Manually verified records for late-season 2026 to fix missing/incorrect data
BACKUP_STANDINGS = {
    'ATL': {'wins': 36, 'losses': 40, 'record': '36-40', 'win_pct': 0.474, 'home_record': '21-17', 'away_record': '15-23'},
    'BOS': {'wins': 61, 'losses': 16, 'record': '61-16', 'win_pct': 0.792, 'home_record': '35-3', 'away_record': '26-13'},
    'BKN': {'wins': 31, 'losses': 47, 'record': '31-47', 'win_pct': 0.397, 'home_record': '19-21', 'away_record': '12-26'},
    'CHA': {'wins': 19, 'losses': 58, 'record': '19-58', 'win_pct': 0.247, 'home_record': '10-28', 'away_record': '9-30'},
    'CHI': {'wins': 37, 'losses': 40, 'record': '37-40', 'win_pct': 0.481, 'home_record': '20-19', 'away_record': '17-21'},
    'CLE': {'wins': 46, 'losses': 31, 'record': '46-31', 'win_pct': 0.597, 'home_record': '25-14', 'away_record': '21-17'},
    'DAL': {'wins': 46, 'losses': 31, 'record': '46-31', 'win_pct': 0.597, 'home_record': '24-15', 'away_record': '22-16'},
    'DEN': {'wins': 53, 'losses': 23, 'record': '53-23', 'win_pct': 0.697, 'home_record': '31-8', 'away_record': '22-15'},
    'DET': {'wins': 13, 'losses': 63, 'record': '13-63', 'win_pct': 0.171, 'home_record': '7-31', 'away_record': '6-32'},
    'GSW': {'wins': 42, 'losses': 34, 'record': '42-34', 'win_pct': 0.553, 'home_record': '20-18', 'away_record': '22-16'},
    'HOU': {'wins': 38, 'losses': 38, 'record': '38-38', 'win_pct': 0.500, 'home_record': '26-13', 'away_record': '12-25'},
    'IND': {'wins': 43, 'losses': 34, 'record': '43-34', 'win_pct': 0.558, 'home_record': '25-15', 'away_record': '18-19'},
    'LAC': {'wins': 49, 'losses': 27, 'record': '49-27', 'win_pct': 0.645, 'home_record': '25-13', 'away_record': '24-14'},
    'LAL': {'wins': 44, 'losses': 33, 'record': '44-33', 'win_pct': 0.571, 'home_record': '27-13', 'away_record': '17-20'},
    'MEM': {'wins': 26, 'losses': 50, 'record': '26-50', 'win_pct': 0.342, 'home_record': '9-28', 'away_record': '17-22'},
    'MIA': {'wins': 42, 'losses': 34, 'record': '42-34', 'win_pct': 0.553, 'home_record': '20-18', 'away_record': '22-16'},
    'MIL': {'wins': 47, 'losses': 29, 'record': '47-29', 'win_pct': 0.618, 'home_record': '29-10', 'away_record': '18-19'},
    'MIN': {'wins': 53, 'losses': 23, 'record': '53-23', 'win_pct': 0.697, 'home_record': '28-10', 'away_record': '25-13'},
    'NOP': {'wins': 45, 'losses': 31, 'record': '45-31', 'win_pct': 0.592, 'home_record': '21-17', 'away_record': '24-14'},
    'NYK': {'wins': 45, 'losses': 31, 'record': '45-31', 'win_pct': 0.592, 'home_record': '25-14', 'away_record': '20-17'},
    'OKC': {'wins': 52, 'losses': 24, 'record': '52-24', 'win_pct': 0.684, 'home_record': '29-8', 'away_record': '23-16'},
    'ORL': {'wins': 45, 'losses': 31, 'record': '45-31', 'win_pct': 0.592, 'home_record': '27-11', 'away_record': '18-20'},
    'PHI': {'wins': 42, 'losses': 35, 'record': '42-35', 'win_pct': 0.545, 'home_record': '22-15', 'away_record': '20-20'},
    'PHO': {'wins': 45, 'losses': 31, 'record': '45-31', 'win_pct': 0.592, 'home_record': '24-15', 'away_record': '21-16'},
    'POR': {'wins': 20, 'losses': 56, 'record': '20-56', 'win_pct': 0.263, 'home_record': '11-27', 'away_record': '9-29'},
    'SAC': {'wins': 44, 'losses': 32, 'record': '44-32', 'win_pct': 0.579, 'home_record': '22-15', 'away_record': '22-17'},
    'SAS': {'wins': 18, 'losses': 58, 'record': '18-58', 'win_pct': 0.237, 'home_record': '10-28', 'away_record': '8-30'},
    'TOR': {'wins': 23, 'losses': 53, 'record': '23-53', 'win_pct': 0.303, 'home_record': '13-25', 'away_record': '10-28'},
    'UTA': {'wins': 29, 'losses': 47, 'record': '29-47', 'win_pct': 0.382, 'home_record': '20-18', 'away_record': '9-29'},
...
TEAM_DATA = {
    ...
    'DET': {'off_rtg': 109.5, 'def_rtg': 118.6}, 'GSW': {'off_rtg': 117.1, 'def_rtg': 114.9},
    ...
    'SAS': {'off_rtg': 109.4, 'def_rtg': 116.0}, 'TOR': {'off_rtg': 114.5, 'def_rtg': 117.8},
